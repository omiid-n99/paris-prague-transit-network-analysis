...
To understand the natural substructures of the transit networks, modularity-based community detection was applied.
This analysis groups stops that are more densely connected to each other than to the rest of the network, revealing functional clusters that often correspond to geographic neighborhoods or distinct transit lines.
In both cities, communities align closely with major transport corridors and administrative zones, illustrating the interplay between urban planning and network topology.
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \label{fig:mil_mod}
    \end{subfigure}
    \caption{Visualization of network communities 
detected by the Greedy Modularity algorithm. Colors indicate distinct communities.}
